...
#> 1          44.18129          TRUE      64.63784  64.63784   1.131775  0.5363836
...
| queue_size | target_queue_size | queue_too_big | mean_wait_age |
|:----------:|:-----------------:|:-------------:|:-------------:|
|    185     |     44.18129      |     TRUE      |   64.63784    |

There is a column to report the average waiting time of the patients on
the list, which is 64.64 weeks, compared to our target of 18 weeks.
...
#>   target_queue_size queue_too_big mean_wait_age mean_wait cv_arrival cv_removal
#> 1          45.47063         FALSE      6.863636  6.863636   1.153809  0.6896719
#>   target_capacity relief_capacity  pressure
...
#>   target_queue_size queue_too_big mean_wait_age mean_wait cv_arrival cv_removal
#> 1          43.64507         FALSE     0.8571429 0.8571429   1.173034  0.7247564
#>   target_capacity relief_capacity  pressure
